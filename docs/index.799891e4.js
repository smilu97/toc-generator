...
})({"1zKXX":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
var _tocgen = require("./tocgen");
var _tocgenDefault = parcelHelpers.interopDefault(_tocgen);
const inputTextArea = document.getElementById('ta-input');
const outputTextArea = document.getElementById('ta-output');
const convertButton = document.getElementById('ta-btn');
const input = '';
function handleClickConvert() {
    const input1 = inputTextArea.value;
    const result = _tocgenDefault.default(input1);
...
},{"bootstrap/dist/js/bootstrap":"9AxfY","./tocgen":"kmyTs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9AxfY":[function(require,module,exports) {
/*!
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kmyTs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function countPriorChar(s, ch) {
...
function convert(input) {
    return removeCodeBlocks(input).map(mapToLevelAndTitle).filter((el)=>el.level > 0
    ).map(mapToLine).join('\n');
}
exports.default = convert;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1zKXX","h7u1C"], "h7u1C", "parcelRequireda02")
